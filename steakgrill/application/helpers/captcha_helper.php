...
{
$defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '150', 'img_height' => '30', 'font_path' => '', 'expiration' => 7200, 'word_length' => 6, 'pool' => '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ');
...
{
$word .=ucwords($pool[mt_rand(0, $mt_rand_max)]);
}
}
elseif ( ! is_string($word))
{
$word = ucwords((string) $word);
}
