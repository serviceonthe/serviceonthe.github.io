...
<div class="template-page-wrapper">
	...
	<!--all code here -->
        ...
        <a href="<?php echo base_url();?>/index.php/admin/restaurent/cuisine_category_menu_setting"><button type="button" class="btn btn-success">Add Caregory For Cuisine Type</button></a>
        <a href=""><button type="button" class="btn btn-success">Add Cuisine Item</button></a>
        <?php echo form_open('admin/restaurent/category_filter'); ?>
    ...
    <div class="panel-body">
                <div class="table-responsive">
                    <?php echo form_open('admin/restaurent/add_cuisine_item'); ?>
