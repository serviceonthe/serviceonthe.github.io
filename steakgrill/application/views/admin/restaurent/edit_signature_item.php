...
<div class="template-page-wrapper">
    <div class="templatemo-content">
        ...
        <!--all code here -->
        <a href="<?php echo base_url();?>/index.php/admin/restaurent/restaurent_menu_setting"><button type="button" class="btn btn-success">Indian Menus Selection</button></a>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <?php echo form_open('admin/restaurent/signature_item_update'); ?>
