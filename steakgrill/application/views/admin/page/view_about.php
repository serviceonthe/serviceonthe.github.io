     ...
     <div class="row mt">
        <div class="col-lg-12">
          	<div class="form-panel">
				<h3 class="panel-title"><i class="fa fa-plus-circle"></i> About section</h3>
          	</div>
			<div class="form-panel">
			    <?php
                            ...
                            <tbody> 
                                ...
                                {?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo anchor('admin/pages/about_delete/'.$menu['about_id'],'<button type="button" class="btn btn-danger">Delete</button>',array("onclick"=>"return confirm('Are you sure?')"));?>
                                                <?php echo anchor('admin/pages/about_edit/'.$menu['about_id'],'<button type="button" class="btn btn-info">Edit</button>');?>
                                            </td>
                                        </tr>  
                                <?php }
