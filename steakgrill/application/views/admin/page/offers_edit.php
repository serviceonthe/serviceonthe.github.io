    ...
    <div class="row mt">
        <div class="col-lg-12">
          	<div class="form-panel">
				<h3 class="panel-title"><i class="fa fa-plus-circle"></i> Offers section</h3>
          	</div>
			<div class="form-panel">
			    <?php
	            ...
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <div class="table-responsive">
			    			<?php echo form_open_multipart('admin/pages/offers_update'); ?>
	                        <table width="70%" border="0" cellpadding="15" cellspacing="5" class="table-hover">
					            <td> &nbsp; &nbsp; </td>
					              <tr>
					                <td width="21%"><label>Offer Main title</label></td>
					                <td width="79%"><input class="form-control" type="text" name="offer_main_title" value="<?php echo $offer_main_title;?>" size="30" /></td>
					              </tr>
					              <tr>
					                <td width="21%"><label>Offer short description</label></td>
					                <td width="79%"><label><textarea class="form-control ckeditor" name="offer_short_description"  rows="5" cols="75" ><?php echo $offer_short_description;?></textarea></label></td>
					              </tr>
					              					              <tr>
					                <!-- <td width="21%"><label>Image</label></td> -->
					                <!-- <td width="79%"><label><input class="form-control" type="file" name="image" /></label></td> -->
					                <input class="form-control" type="hidden" name="offer_id" value="<?php echo $offer_id;?>" size="30" />
					              </tr>
					              <tr>
					                <td></td>
