...
<div class="template-page-wrapper">
	...
	<!--all code here -->
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">All Order Statements</h1>
                </div>
            </div>     
                                ...
                                <tbody> 
                                    <tr>
                                         <td colspan="2" align="right" style="padding-right:10px">
                                             <b>Restaurant Name</b> <input type="text" name="r_name" value="" class="text_box"/>
                                         </td>
                                         <td colspan="2" align="right" style="padding-right:10px">
                                    ...
                                    foreach($order_statement as $key){?>
                                        <tr>
                                            <td><?php echo $id; $id++; ?></td>
                                             <td><a href="<?php echo site_url('admin/dashboard/restaurant_order_statement/'.$key['res_id']);?>"><?php echo $key['res_name'];?></a></td>    
