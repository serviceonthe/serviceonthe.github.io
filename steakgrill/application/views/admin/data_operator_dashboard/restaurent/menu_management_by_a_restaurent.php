                                                ...
                                                <tr id="tr_del<?php echo $result->item_id;?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div id="change_price<?php echo $result->item_id;?>" style="display: none">
                                                            <br/>
                                                            <?php echo form_open('admin/data_operator_restaurent/change_item_price_by_a_restaurent'); ?>
                                                ...
                                                <tr id="tr_del<?php echo $result->item_id;?>">
                                                    ...
                                                    <td>
                                                        <div id="price_box_<?php echo $result->item_id;?>" style="display: none;">
                                                            <?php
                                                                echo form_open('admin/data_operator_restaurent/add_menu_price_by_a_restaurent');
                                                            ?>
