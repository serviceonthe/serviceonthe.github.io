...
<div class="template-page-wrapper">
    ...
    <table width="100%">
        <tr>
            <td align="left"><a href="<?php echo base_url();?>/index.php/admin/data_operator_restaurent/signature_item" class="btn btn-success">Add Signature Item</a> <a href="<?php echo base_url();?>/index.php/admin/data_operator_restaurent/menu_manage" class="btn btn-success">All Menu List</a></td>
            
            <td align="right"><a href="<?php echo base_url();?>/index.php/admin/data_operator_restaurent/finish_restaurent_entry" class="btn btn-danger" margin-left="500px">Finish Entry</a></td>
        </tr>
    </table>
                                                ...
                                                <tr id="tr_del<?php echo $result->item_id;?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div id="change_price<?php echo $result->item_id;?>" style="display: none">
                                                            <br/>
                                                            <?php echo form_open('admin/data_operator_restaurent/change_item_price'); ?>
                                                ...
                                                <tr id="tr_del<?php echo $result->item_id;?>">
                                                    ...
                                                    <td>
                                                        <div id="price_box_<?php echo $result->item_id;?>" style="display: none;">
                                                            <?php
                                                                echo form_open('admin/data_operator_restaurent/add_menu_price');
                                                            ?>
