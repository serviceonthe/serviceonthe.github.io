    ...
    <div class="row mt">
        <div class="col-lg-9">
          	...
          	<div class="form-panel">
				<h3 class="panel-title"><i class="fa fa-list-alt"></i> Edit News Letter</h3>
          	</div>
		...
		<div class="form-panel">
                ...
                <a href="<?php echo base_url();?>admin/mail/list_newsletter"><button type="button" class="btn btn-success">List News Letter</button></a>
                  ...
                  <?php if($this->session->flashdata('message')){echo $this->session->flashdata('message');}?>
                    ...
                    <?php  echo form_open('admin/mail/edit_newsletter');?>
			<div class="form-group">
			<label for="inputEmail3" class="col-sm-2 control-label">News Letter Title:</label>
                            <div class="col-sm-8">
                                <input type="text" name="newsletter_title" value="<?php echo $edit_newsletter['newsletter_title'];?>"class="form-control" />
                            </div>
			</div>
			...
			<label for="inputEmail3" class="col-sm-2 control-label">News Letter Body:</label>
                            <div class="col-sm-8">
                                <textarea class="ckeditor form-control" name="newsletter_body" rows="13" cols="75" ><?php echo $edit_newsletter['newsletter_body'];?></textarea>
                            </div>
			</div>
                            <input type="hidden" name="newsletter_id" value="<?php echo $edit_newsletter['newsletter_id'];?>"/>
