              ...
              <ul>
                ...
                <li>
                  <div class="post-box">
                    ...
                    <div class="post-frame"> <a href="<?php echo base_url(); ?>post-view/<?php echo $post->entry_id; ?>"> <img style="width: 770px; height: 306px; " src="<?php echo base_url()."assets/blog/feature/".$post->feature_img;?>" alt="img">
                        </a>
