...
<div class="template-page-wrapper">
	...
	<!--all code here -->
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Reservation Statements of Restaurant </h1> 
                </div>
            </div>           
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-left: 10px; margin-bottom: 5px;">
                                <tbody>
                                    <tr>
                                         ...
                                         <td colspan="2" align="right" style="padding-right:10px">
                                             Reservation id <input type="text" name="ord_id1" value="" class="text_box"/>
                                         </td> 
                                         <td colspan="2" align="right" style="padding-right:10px">
                                             Customer Name <input type="text" name="cus_name1" value="" class="text_box"/>
                                         </td>
                                         <td colspan="2" align="right" style="padding-right:10px">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 10px;">
                                    <thead>                                
                                        <tr>
                                            ...
                                            <th>Total Guest</th>
                                            <th>Commission</th>
                                            <th>Reservation Submission Date</th>
                                   ...
                                   <?php if(count($restaurant_statement) > 0  ) { 
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo site_url('admin/dashboard/restaurant_reservation_statement/'.$key['res_id']);?>"><?php echo $key['res_name'];?></a></td>    
                                            ...
                                            <td><?php $total_guest=$key['people'];
                                            
                                                $statement=($total_guest * 2);
                                                if($statement > 10){
                                                    echo $statement=10; 
                                                }  else {
                                                    echo $statement; 
