        ...
        <div class="row mt">
            <div class="col-lg-9">
                <div class="form-panel">
                    <h3 class="panel-title">Bulk Coupon Edit </h3>
                </div>
                <div class="form-panel">
                    ...
                    <div class="form-horizontal style-form"> 
                        <?php echo form_open('admin/settings/edit_bulk_coupon'); ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name='coupon_type' id='coupon_type'>
                                    <option <?php if($voucher->coupon_type=='one time'){echo 'selected';} ?> value='one time'>One Time</option>
                                    <option <?php if($voucher->coupon_type=='permanent'){echo 'selected';} ?> value='permanent'>Permanent</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name='coupon_value_type'>
                                    <option <?php if($voucher->coupon_value_type=='fixed'){echo 'selected';}?> value='fixed'>Fixed</option>
                                    <option <?php if($voucher->coupon_value_type=='percentage'){echo 'selected';}?> value='percentage'> Percentage</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control"  required name='coupon_amount' type='text' placeholder='Enter expire date' value="<?php echo $voucher->coupon_amount; ?>" />
                            </div>
                        </div>
                        <input name='coupon_id' type='hidden' value="<?php echo $voucher->coupon_id; ?>" > 
