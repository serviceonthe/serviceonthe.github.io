...
<div class="template-page-wrapper">
	...
	<!--all code here -->
        <div id="page-wrapper">
            <div id="message"></div>
                <legend class="scheduler-border">Order Report Count</legend>
                    <button type="button" class="btn btn-success">Total Data >> <?php echo count($order); ?></button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Order Report By Date To Date Search</h1>
                    <?php echo form_open('admin/tele_operator_dashboard/order_list_report');?>
                     <!--<form action="order_list_report" method="POST">    -->
