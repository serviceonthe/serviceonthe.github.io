(function($) {
	...
	//Team Carousel One
	if($('.team-carousel-one .team-slider').length){
		$('.team-carousel-one .team-slider').bxSlider({
			adaptiveHeight: true,
			auto:true,
			controls: true,
			pager:true,
	...
	//Custom Pager Carousel / Testimonial Style Two
	if($('.custom-pager-carousel').length){
		$('.custom-pager-carousel').bxSlider({
			adaptiveHeight: true,
			auto:true,
			controls: true,
			pause: 5000,
	...
	if($('#countdown-timer').length){                     
		$('#countdown-timer').countdown('2016/08/14', function(event) {
